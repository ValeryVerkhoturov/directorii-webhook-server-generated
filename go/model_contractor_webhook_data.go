...
type ContractorWebhookData struct {

	LeadInfo *ContractorWebhookLeadInfo `json:"LeadInfo,omitempty"`

	Documents *ContractorWebhookDocuments `json:"Documents,omitempty"`

	Commission *ContractorWebhookCommission `json:"Commission,omitempty"`

	CustomerFeedback *ContractorWebhookCustomerFeedback `json:"CustomerFeedback,omitempty"`

	Offer *ContractorWebhookOffer `json:"Offer,omitempty"`

	RejectReason *ContractorWebhookRejectReason `json:"RejectReason,omitempty"`
}
