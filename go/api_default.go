...
func LeadCreatedOrUpdated(w http.ResponseWriter, r *http.Request) {
	...
	// Deserialize the JSON into ContractorWebhookPayload
	var payload ContractorWebhookPayload
	...
	// Serialize the ContractorWebhookPayload into JSON
	...
	log.Printf("Received webhook payload: %+v", string(jsonData))
